...
- The rewrite has started with the export-domain and settings-domain slices under local validation, CI-backed checks, regular `logics` updates, and checkpoint commits.
