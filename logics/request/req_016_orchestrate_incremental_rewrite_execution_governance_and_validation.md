...
- The rewrite has started with the export-domain, settings-domain, and ETA-domain slices under local validation, CI-backed checks, regular `logics` updates, and checkpoint commits.
